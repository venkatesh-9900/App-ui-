...
const iam_logout_url = (idToken: String) => `http://35.225.223.235:8080/realms/main/protocol/openid-connect/logout?id_token_hint=${idToken}&post_logout_redirect_uri=https%3A%2F%2Flocalhost%3A20000`;
