import { AlertTriangle, ArrowRightLeft, BarChart, Bell, Bot, ClipboardCheck, Home, Network, Search, Settings, ShieldCheck, Wallet, History, Sliders, Gauge, Users, Cog, Key, Code, Book, Plug, CreditCard, Building, MessageSquarePlus, } from "lucide-react";
...
const navigation = [
  {
    ...
    items: [
      ...
      { name: "New Chat", href: "/chat/new", icon: MessageSquarePlus },
