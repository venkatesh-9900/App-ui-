...
export const ENDPOINTS = {
    ...
    IAM: {
        ...
        USER_GROUP_MAPPINGS_BULK: `/api/groups/user-mappings/bulk`,
        GROUP_ROLE_MAPPINGS: `/api/groups/role-mappings`,
        GROUP_ROLE_MAPPINGS_BULK: `/api/groups/role-mappings/bulk`,
        USER_ROLE_MAPPINGS: `/api/roles/user-mappings`,
        USER_ROLE_MAPPINGS_BULK: `/api/roles/user-mappings/bulk`,
