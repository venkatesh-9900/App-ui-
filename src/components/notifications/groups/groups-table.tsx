...
import { MoreHorizontal, Pencil, Trash2, Copy, Calendar } from 'lucide-react'
        ...
        <div className="overflow-x-auto flex-1">
          <Table className="w-full border-collapse">
            <TableHeader className="bg-muted sticky top-0 z-10">
              <TableRow>
                <TableHead className="px-4 py-2 text-left w-1/4 min-w-max">Topic</TableHead>
                <TableHead className="px-4 py-2 text-left w-2/5 min-w-max">Key</TableHead>
                ...
                <TableHead className="px-4 py-2 text-left w-1/6 min-w-max">Updated</TableHead>
                <TableHead className="px-4 py-2 text-right w-20 min-w-max">Actions</TableHead>
              </TableRow>
            </TableHeader>
                  ...
                  <TableCell className="px-4 py-3 w-20 min-w-max text-right">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem onClick={() => onCopyKey(group.novu_topic_key)}>
